...
class WebDashboard(commands.Cog):
    def __init__(self, bot):
        ...
        self.DISCORD_CLIENT_ID = ''  # Hier deine Client ID eintragen
        self.DISCORD_CLIENT_SECRET = ''  # Hier dein Client Secret eintragen
        ...
        self.AUTHORIZED_USERS = [
            '',  # Hier deine Discord-Benutzernamen eintragen
            '',
            ''
        ]
    ...
    async def dashboard_stats(self, ctx):
        ...
        try:
            ...
            embed.add_field(name="Web Dashboard", value="[Hier klicken](http://neko.wisp.uno:12902)", inline=True)
